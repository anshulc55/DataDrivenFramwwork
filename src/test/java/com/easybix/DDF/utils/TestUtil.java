...
public class TestUtil {
	...
	public static void checkTestRunMode(String sheetName, String testName) {
		...
		Xls_Reader xls = new Xls_Reader(Contants.TESTCASESLIST_FILE_PATH);
	...
	public static Object[][] getTestData(String sheetName, String testName){
		//Read xls file
		Xls_Reader XlsReader = new Xls_Reader(Contants.TESTCASESDATA_FILE_PATH);
